    ...
    <>
      <main>
        ...
        <section className="ui-relative ui-overflow-hidden ui-border-b ui-border-[var(--ui-border)]">
          <div
            aria-hidden="true"
            className="ui-pointer-events-none ui-absolute ui-inset-0 ui-z-0 ui-overflow-hidden"
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at center, var(--ui-primary), transparent 70%)",
              }}
            />
          </div>
          ...
          <div className="ui-relative ui-z-10 ui-mx-auto ui-grid ui-max-w-5xl ui-grid-cols-1 ui-gap-12 ui-px-6 ui-pb-28 ui-pt-28 lg:ui-grid-cols-2 lg:ui-items-center lg:ui-pt-36">
            <div>
                ...
                {stack.map((s, i) => (
                  <span key={s} className="ui-flex ui-items-center ui-gap-2">
                    {i > 0 && (
                      <span
                        aria-hidden="true"
                        className="ui-h-1 ui-w-1 ui-rounded-full ui-bg-[var(--ui-border)]"
                      />
                    )}
                    {s}
                  </span>
              ...
              <p className="ui-mt-6 ui-max-w-md ui-text-[var(--ui-text-lg)] ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                Labanaat UI is a modern, accessible React component library designed for building
                production-ready interfaces — 47 components, one consistent way to use them, and a
                token system that makes it genuinely yours.
              </p>
              <div className="ui-mt-8 ui-flex ui-flex-wrap ui-items-center ui-gap-3">
                ...
                <Button size="lg" variant="outline" asChild>
                  <a href="https://github.com/Mohammed-Saif-Ibrahim/labanaat">View source</a>
                </Button>
              </div>
                  ...
                  <div className="ui-flex ui-flex-col ui-gap-5">
                    <div className="ui-flex ui-items-center ui-gap-3">
                      ...
                      <div className="ui-flex-1">
                        <div className="ui-text-[var(--ui-text-sm)] ui-font-medium ui-text-[var(--ui-fg)]">
                          Ada Lovelace
                        </div>
                        <div className="ui-text-[var(--ui-text-xs)] ui-text-[var(--ui-fg-muted)]">
                          ada@example.com
                        </div>
                      </div>
          ...
          <section className="ui-border-b ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg-subtle)]">
            <div className="ui-mx-auto ui-max-w-5xl ui-px-6 ui-py-16">
              <p className="ui-mb-8 ui-max-w-md ui-text-[var(--ui-fg-muted)]">
                Numbers you can check against the repository yourself — nothing here is a marketing
                estimate.
              </p>
              <div className="ui-grid ui-grid-cols-2 ui-gap-8 sm:ui-grid-cols-4">
                {stats.map((s) => (
                  <div key={s.label}>
                    <div className="ui-font-mono ui-text-3xl ui-font-medium ui-text-[var(--ui-fg)]">
                      {s.value}
                    </div>
                    <div className="ui-mt-1 ui-text-[var(--ui-text-sm)] ui-text-[var(--ui-fg-muted)]">
                      {s.label}
                    </div>
                  </div>
                ))}
          ...
          <div className="ui-relative ui-z-10 ui-mx-auto ui-max-w-5xl ui-px-6 ui-py-36">
            <Reveal>
              ...
              <p className="ui-mt-4 ui-max-w-lg ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                None of this is glamorous work, which is exactly why it keeps getting skipped,
                rushed, or copy-pasted from the last project. Labanaat exists so your team spends
                its time on the product, not on reinventing a dropdown.
              </p>
            </Reveal>
            <div className="ui-mt-14 ui-grid ui-grid-cols-1 ui-gap-10 md:ui-grid-cols-2">
              {painPoints.map((p, i) => (
                <Reveal key={p.title} delay={i * 100}>
                  <div>
                    <div
                      className="ui-mb-4 ui-h-px ui-w-10"
                      style={{ background: "var(--ui-primary)" }}
                      aria-hidden="true"
                    />
                    <h3 className="ui-mb-2 ui-text-[var(--ui-text-lg)] ui-font-semibold ui-text-[var(--ui-fg)]">
                      {p.title}
                    </h3>
        ...
        <section className="ui-relative ui-overflow-hidden ui-border-t ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg-subtle)]">
          ...
          <div className="ui-relative ui-z-10 ui-mx-auto ui-max-w-5xl ui-px-6 ui-py-36">
            <Reveal>
              ...
              <p className="ui-mt-4 ui-max-w-lg ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                A sample of what's in the box — every piece below is a real, live instance of the
                library, sharing the same accent color you pick in the header, not a static mockup
                or screenshot.
              </p>
            </Reveal>
            ...
            <Reveal delay={150}>
              <div className="ui-mt-14 ui-grid ui-grid-cols-2 ui-gap-4 md:ui-grid-cols-4 md:ui-grid-rows-2">
                <div className="ui-col-span-2 ui-row-span-2 ui-rounded-[var(--ui-radius-lg)] ui-border ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg)] ui-p-5">
                  <span className="ui-mb-4 ui-block ui-text-[var(--ui-text-xs)] ui-font-medium ui-uppercase ui-tracking-wide ui-text-[var(--ui-fg-muted)]">
                    Table
                  </span>
                  <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell className="ui-flex ui-items-center ui-gap-2">
                          <Avatar name="Ada Lovelace" size="sm" />
                          Ada Lovelace
                        </TableCell>
                        <TableCell>
                ...
                <div className="ui-rounded-[var(--ui-radius-lg)] ui-border ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg)] ui-p-5">
                  ...
                  <Accordion type="single" collapsible defaultValue="a">
                    <AccordionItem value="a">
                      <AccordionTrigger className="ui-py-1.5 ui-text-[var(--ui-text-sm)]">
                        Refunds
                      </AccordionTrigger>
                      <AccordionContent className="ui-text-[var(--ui-text-xs)]">
            ...
            <Reveal delay={250}>
              <div className="ui-mt-6">
                <Alert variant="neutral" title="This is one page.">
                  Every component on this section — table, buttons, badges, accordion, tabs, form
                  controls — is imported straight from{" "}
                  <code className="ui-rounded-[var(--ui-radius-sm)] ui-bg-[var(--ui-bg-muted)] ui-px-1.5 ui-py-0.5 ui-font-mono ui-text-[13px]">
                    @labanaat/ui
                  </code>
                  .
                </Alert>
        ...
        <section className="ui-relative ui-overflow-hidden ui-border-t ui-border-[var(--ui-border)]">
          <div className="ui-mx-auto ui-max-w-5xl ui-px-6 ui-py-36">
            <Reveal>
              ...
              <p className="ui-mt-4 ui-max-w-lg ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                Drag-and-drop boards, charts, query builders, activity feeds — the same design
                system, the same tokens, the same accessibility bar. Drag a card below; it's a real
                board, not a screenshot.
              </p>
            </Reveal>
                  ...
                  <div className="ui-rounded-[var(--ui-radius-lg)] ui-border ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg)] ui-p-5">
                    ...
                    <ActivityFeed>
                      <ActivityItem>
                        ...
                        <ActivityContent>
                          <ActivityText>
                            <strong>Ada Lovelace</strong> invited <strong>Grace Hopper</strong>
                          </ActivityText>
                      ...
                      <ActivityItem>
                        ...
                        <ActivityContent>
                          <ActivityText>
                            <strong>Alan Turing</strong> created project <strong>Enigma</strong>
                          </ActivityText>
            ...
            <Reveal delay={250}>
              <div className="ui-mt-6">
                <Alert variant="neutral" title="Same rules apply.">
                  Kanban ships real keyboard drag support via dnd-kit's keyboard sensor, DataGrid
                  and Chart aren't shown here but follow the exact same pattern — see the full{" "}
                  <a
                    href="/docs/components"
                    className="ui-text-[var(--ui-primary)] hover:ui-underline"
                  >
                    component catalog
                  </a>
                  .
        ...
        <section className="ui-border-t ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg-subtle)]">
          <div className="ui-mx-auto ui-max-w-5xl ui-px-6 ui-py-36">
            <Reveal>
              ...
              <p className="ui-mt-4 ui-max-w-lg ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                Not component demos — three full, real applications, each built entirely from this
                library. Every page is live: open one, click around, drag things, view the source.
              </p>
            </Reveal>
                ...
                {[
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, color-mix(in srgb, ${t.accent} 22%, transparent), color-mix(in srgb, ${t.accent} 6%, transparent))`,
                      }}
                    />
            ...
            <Reveal delay={250}>
              <div className="ui-mt-8 ui-text-center">
                <a
                  href="/templates"
                  className="ui-text-[var(--ui-text-sm)] ui-font-medium ui-text-[var(--ui-primary)] hover:ui-underline"
                >
          ...
          <div className="ui-mx-auto ui-grid ui-max-w-5xl ui-grid-cols-1 ui-gap-10 ui-px-6 ui-py-36 lg:ui-grid-cols-2 lg:ui-items-center">
            <Reveal>
              <div>
                ...
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Color, spacing, radius, typography, shadow, and motion all resolve to a CSS
                  variable defined once. Rebrand a whole app by overriding a handful of variables —
                  no component code changes, no rebuild.
                </p>
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  The color picker in the header above isn't decoration — it calls the exact same{" "}
                  <code className="ui-font-mono ui-text-[13px] ui-text-[var(--ui-fg)]">
                    applyTokenOverrides()
                  </code>{" "}
                  function you'd call in your own app. Twelve presets ship built in, and nothing
                  stops you from passing your own hex values instead.
                </p>
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Even the neutral surfaces — card backgrounds, dividers, subtle fills — pick up a
                  faint wash of whatever accent is active, via{" "}
                  <code className="ui-font-mono ui-text-[13px] ui-text-[var(--ui-fg)]">
                    color-mix()
                  </code>
                  , so a theme change feels coherent instead of like one button changed color on an
                  otherwise gray page.
                </p>
              </div>
            </Reveal>
            <Reveal delay={150}>
              <CodeBlock>
                ...
                <br />
                <br />
                <C>{`// every component picks this up automatically`}</C>
                <br />
          ...
          <div className="ui-mx-auto ui-grid ui-max-w-5xl ui-grid-cols-1 ui-gap-10 ui-px-6 ui-py-36 lg:ui-grid-cols-2 lg:ui-items-center">
            <Reveal className="lg:ui-order-2">
              <div>
                ...
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Keyboard navigation, focus trapping, and correct ARIA roles are built into every
                  interactive component — not bolted on. Every component ships with axe-core
                  assertions, not just a claim in the docs.
                </p>
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Complex patterns — Dialog, Select, Combobox, Tabs — use Radix Primitives
                  internally for behavior that's been battle-tested across thousands of production
                  apps, wrapped in the library's own styling and API.
                </p>
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Where no accessible primitive existed — Combobox has none in Radix today — it's
                  implemented directly against the WAI-ARIA 1.2 pattern rather than reaching for an
                  unmaintained dependency just to check a box.
                </p>
              </div>
            </Reveal>
            <Reveal delay={150}>
              <CodeBlock>
                ...
                <S>"vitest-axe"</S>;<br />
                <br />
                <K>it</K>(<S>"has no violations"</S>, <K>async</K> () =&gt; {`{`}
                <br />
                {"  "}
                <K>const</K> {`{ container }`} = render(&lt;Combobox /&gt;);
                <br />
                {"  "}expect(<K>await</K> axe(container)).toHaveNoViolations();
                <br />
                {`});`}
              </CodeBlock>
            </Reveal>
            ...
            <div className="ui-grid ui-grid-cols-1 ui-gap-10 lg:ui-grid-cols-2 lg:ui-items-center">
              <Reveal>
                <div>
                  ...
                  <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                    36 of 47 components have a dedicated behavior test file, and the full library
                    runs through a cross-component accessibility sweep against axe-core covering 40
                    — the same commands wired into a CI pipeline that runs on every pull request,
                    not just before a release. Every component has at least one of the two; closing
                    the remaining gap between the two sets is the next priority.
                  </p>
                  <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                    Interaction-heavy components get interaction-heavy tests — the Slider suite, for
                    example, simulates real keyboard drags and asserts the displayed value actually
                    updates live, for both single and range selection.
                  </p>
                  <dl className="ui-mt-6 ui-grid ui-grid-cols-2 ui-gap-4">
                    <div>
                      <dt className="ui-text-[var(--ui-text-xs)] ui-text-[var(--ui-fg-muted)]">
                        Test files
                      </dt>
              ...
              <Reveal delay={150}>
                <CodeBlock>
                  ...
                  <br />
                  <br />
                  <S>{` ✓ src/components/button/Button.test.tsx (5 tests)`}</S>
                  <br />
                  <S>{` ✓ src/components/slider/Slider.test.tsx (4 tests)`}</S>
                  <br />
                  <S>{` ✓ src/components/combobox/Combobox.test.tsx (3 tests)`}</S>
                  <br />
                  <S>{` ✓ src/components/calendar/Calendar.test.tsx (11 tests)`}</S>
                  <br />
                  <S>{` ✓ src/test/accessibility.a11y.test.tsx (27 tests)`}</S>
                  <br />
                  <br />
                  <C>{` Test Files  38 passed (38)`}</C>
                  <br />
        ...
        <section className="ui-border-t ui-border-[var(--ui-border)] ui-bg-[var(--ui-bg-subtle)]">
          <div className="ui-mx-auto ui-max-w-5xl ui-px-6 ui-py-36">
            <Reveal>
              ...
              <p className="ui-mt-4 ui-max-w-lg ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                Both cards below render simultaneously, independent of the toggle in the header,
                using the exact hex values the current accent resolves to in each theme — including
                the swatches underneath, so there's nothing to take on faith.
              </p>
            </Reveal>
            <Reveal delay={150}>
          ...
          <div className="ui-mx-auto ui-grid ui-max-w-5xl ui-grid-cols-1 ui-gap-10 ui-px-6 ui-py-36 lg:ui-grid-cols-2 lg:ui-items-center">
            <Reveal>
              <div>
                ...
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Card, Dialog, Drawer, and Accordion expose subcomponents instead of a wall of
                  configuration props. Read the JSX, know the layout — no prop-hunting through
                  documentation to find the one flag that changes the footer alignment.
                </p>
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  It's the same philosophy end to end: components describe structure, tokens
                  describe appearance, and neither one leaks into deciding things the other should
                  own.
                </p>
              </div>
            </Reveal>
              ...
              {workflow.map((w, i) => (
                <Reveal key={w.step} delay={i * 120}>
                  <div>
                    ...
                    <p className="ui-mb-4 ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                      {w.body}
                    </p>
          ...
          <Reveal>
            <div className="ui-relative ui-z-10 ui-mx-auto ui-grid ui-max-w-5xl ui-grid-cols-1 ui-items-center ui-gap-10 ui-px-6 ui-py-36 lg:ui-grid-cols-2">
              <div>
                ...
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  Every component ships its own entry point, so you only bundle what you import — 47
                  components, one consistent way to reach for any of them, from a Button to a full
                  DataGrid.
                </p>
                <p className="ui-mt-4 ui-max-w-md ui-leading-relaxed ui-text-[var(--ui-fg-muted)]">
                  No config file to write before your first component renders, no design tokens to
                  define from scratch — pick an accent color and start building.
                </p>
              ...
              <CodeBlock>
                ...
                <br />
                <C>{`// that's it — no provider, no config`}</C>
                <br />
